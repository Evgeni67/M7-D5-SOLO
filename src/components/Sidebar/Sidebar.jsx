...
const mapDispatchToProps = (dispatch) => ({
  addPlaylist: (playlistName) =>
    ...
    changeCurrentPlaylist: (playlistName) =>
    dispatch({
...
class Sidebar extends Component {
  ...
  changeAddFormVisability = async (e) => {
    if (this.state.showAddPlaylistForm === true) {
      await this.props.addPlaylist(this.state.newPlaylistName);
      this.setState({ showAddPlaylistForm: false });
    } else {
      this.setState({ showAddPlaylistForm: true });
    }
  };
  changeNewPlaylistName = (e) => {
    this.setState({ newPlaylistName: e.currentTarget.value });
  };
  componentDidMount = () => {
    console.log(
      "These are the names sir",
      Object.getOwnPropertyNames(this.props.songsArray.playlists)
    );
  };
  render() {
    return (
      <>
        <nav className="navbar navbar-expand-sm navbar-dark bg-dark navbar-fixed-left">
          <Link to="/">
              ...
              <li className="nav-item">
                ...
                <li className="nav-item">
                  <a className="nav-link">
                    <RiPlayListLine />
                    <a
                      className="ml-1 playlistText"
                      onClick={() => this.changePlaylistVisability()}
                    >
                      Playlists
                    </a>
                    <Container
                    ...
                    >
                      ...
                      <Row className="dropdownPlaylist">
                        ...
                        <FiPlus
                          ...
                          onClick={(e) => this.changeAddFormVisability(e)}
                        />{" "}
                      </Row>
                      <Row className="dropdownPlaylist">
                        <Form
                          className={
                            this.state.showAddPlaylistForm
                              ? "formAddPlaylist"
                              : "formAddPlaylist d-none"
                          }
                        >
                          <Form.Group controlId="formBasicEmail">
                            <Form.Control
                              ...
                              onChange={(e) => this.changeNewPlaylistName(e)}
                            />
                          </Form.Group>
                        </Form>{" "}
                      </Row>
                ...
                <li className="nav-item">
                  ...
                  >
                    <svg
                      ...
                      height="1.3em"
                      viewBox="0 0 16 16"
                      className="bi bi-person-circle mr-1"
                      fill="currentColor"
                      xmlns="http://www.w3.org/2000/svg"
                    >
